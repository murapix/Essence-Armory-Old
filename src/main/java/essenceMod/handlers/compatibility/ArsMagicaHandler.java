...
public class ArsMagicaHandler
{
	...
	{	
		...
		InfuserRecipes.addRecipe(weapon, UpgradeRegistry.WeaponFrostSlow.setLevel(1), UpgradeRegistry.BaseUpgrade, blueRune, blueRune, Items.snowball, Items.snowball, ModItems.infusedStar, ModItems.infusedStar); // Blue Rune + Snow
		...
		InfuserRecipes.addRecipe(weapon, UpgradeRegistry.WeaponWindDamage.setLevel(1), UpgradeRegistry.BaseUpgrade, tarmaRoot, tarmaRoot, Items.feather, Items.feather, ModItems.infusedDiamond, ModItems.infusedDiamond); // Air Essence
