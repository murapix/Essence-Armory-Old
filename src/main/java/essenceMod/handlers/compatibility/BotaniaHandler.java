...
public class BotaniaHandler
{
	...
	public static void addManaDiscountRecipes(ItemStack armor)
	{
		...
		InfuserRecipes.addRecipe(armor, UpgradeRegistry.ArmorManaDiscount.setLevel(1), UpgradeRegistry.BaseUpgrade, manaSteel, manaSteel, manaSteel, ModItems.infusedDiamond, ModItems.infusedDiamond, ModItems.infusedDiamond);
