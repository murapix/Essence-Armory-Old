...
public class ExUHandler
{
	...
	public static void addDivineRecipes(ItemStack weapon)
	{
		...
		InfuserRecipes.addRecipe(weapon, UpgradeRegistry.WeaponDivineDamage.setLevel(1), UpgradeRegistry.BaseUpgrade, unstableNugget, unstableNugget, unstableNugget, ModItems.infusedStar, ModItems.infusedStar, ModItems.infusedStar);// Soul Fragment
