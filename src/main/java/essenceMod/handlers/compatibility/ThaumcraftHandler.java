...
public class ThaumcraftHandler
{
	...
	public static void addTCArmorRecipes(ItemStack armor)
	{
		...
		InfuserRecipes.addRecipe(armor, 0, UpgradeRegistry.ArmorRevealing.setLevel(1), UpgradeRegistry.BaseUpgrade, thaumometer, thaumometer, Items.leather, Items.leather, Items.leather, Items.leather, Items.gold_ingot, Items.gold_ingot);
