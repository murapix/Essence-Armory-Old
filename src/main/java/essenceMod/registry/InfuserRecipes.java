...
import essenceMod.handlers.compatibility.BotaniaHandler;
...
{
	public static Map<Upgrade, Upgrade> upgradeReqs;
	public static Map<Upgrade, ArrayList<ItemStack>> recipeItems;
	public static Map<Class, ArrayList<Upgrade>> itemUpgrades;

	public static void init()
	{
		UpgradeRegistry.init();

		upgradeReqs = new HashMap<Upgrade, Upgrade>();
		recipeItems = new HashMap<Upgrade, ArrayList<ItemStack>>();
		itemUpgrades = new HashMap<Class, ArrayList<Upgrade>>();
	...
	private static void swordRecipes()
	{
		...
		addRecipe(sword, UpgradeRegistry.WeaponFireDoT.setLevel(1), null, Items.coal, ModItems.infusedDiamond, Items.redstone);// Coal
		...
		addRecipe(sword, UpgradeRegistry.WeaponMagicDoT.setLevel(1), null, Items.spider_eye, ModItems.infusedDiamond, Items.redstone);// Spider Eye
		...
		addRecipe(sword, UpgradeRegistry.WeaponWitherDoT.setLevel(1), null, Blocks.soul_sand, ModItems.infusedStar, Items.redstone);// Soul Sand
		...
		addRecipe(sword, UpgradeRegistry.WeaponArmorPiercing.setLevel(1), null, Items.ender_pearl, Items.ender_pearl, Items.ender_pearl, Items.ender_pearl, ModItems.infusedStar, ModItems.infusedStar);// Ender Pearl
		...
		addRecipe(sword, UpgradeRegistry.SwordLifesteal.setLevel(1), null, Items.ghast_tear, Items.ghast_tear, Items.beef, Items.beef, ModItems.infusedStar, ModItems.infusedStar); // Ghast Tears + Raw Meat
		...
		addRecipe(sword, UpgradeRegistry.WeaponKnockback.setLevel(1), null, Items.slime_ball, Items.slime_ball, ModItems.infusedDiamond, ModItems.infusedDiamond);// Slime Ball
		...
		addRecipe(sword, UpgradeRegistry.WeaponBlind.setLevel(1), null, inkSac, inkSac, inkSac, inkSac, ModItems.infusedStar, ModItems.infusedStar); // Soul Sand + Ink Sac
		...
		addRecipe(sword, UpgradeRegistry.WeaponSlow.setLevel(1), null, Blocks.web, Blocks.web, Blocks.soul_sand, Blocks.soul_sand, ModItems.infusedDiamond, ModItems.infusedDiamond); // Cobweb
		...
		addRecipe(sword, UpgradeRegistry.WeaponPhysicalDamage.setLevel(1), null, Items.quartz, Items.quartz, Items.quartz, Items.quartz, ModItems.infusedDiamond, ModItems.infusedDiamond, ModItems.infusedDiamond);// Quartz
		...
		addRecipe(sword, UpgradeRegistry.WeaponWitherDamage.setLevel(1), null, witherSkull, witherSkull, witherSkull, ModItems.infusedStar, ModItems.infusedStar, ModItems.infusedStar);// Wither Skeleton Skull
		...
		addRecipe(sword, UpgradeRegistry.WeaponMagicDamage.setLevel(1), null, potionHarming, potionHarming, potionHarming, ModItems.infusedDiamond, ModItems.infusedDiamond, ModItems.infusedDiamond);// Potion of Harming
		...
		addRecipe(sword, UpgradeRegistry.WeaponFireDamage.setLevel(1), null, Items.blaze_rod, Items.blaze_rod, Items.blaze_rod, ModItems.infusedDiamond, ModItems.infusedDiamond, ModItems.infusedDiamond);// Blaze Rod
	...
	private static void bowRecipes()
	{
		...
		addRecipe(bow, UpgradeRegistry.WeaponFireDoT.setLevel(1), null, Items.coal, ModItems.infusedDiamond, Items.redstone);// Coal
		...
		addRecipe(bow, UpgradeRegistry.WeaponMagicDoT.setLevel(1), null, Items.spider_eye, ModItems.infusedDiamond, Items.redstone);// Spider Eye
		...
		addRecipe(bow, UpgradeRegistry.WeaponWitherDoT.setLevel(1), null, Blocks.soul_sand, ModItems.infusedStar, Items.redstone);// Soul Sand
		...
		addRecipe(bow, UpgradeRegistry.WeaponArmorPiercing.setLevel(1), null, Items.ender_pearl, Items.ender_pearl, Items.ender_pearl, Items.ender_pearl, ModItems.infusedStar, ModItems.infusedStar);// Ender Pearl
		...
		addRecipe(bow, UpgradeRegistry.BowArrowSpeed.setLevel(1), null, Items.slime_ball, Items.slime_ball, Items.feather, Items.feather, ModItems.infusedDiamond, ModItems.infusedDiamond); // Slime + Feathers
		...
		addRecipe(bow, UpgradeRegistry.BowDrawSpeed.setLevel(1), null, Items.sugar, Items.sugar, Items.string, Items.string, ModItems.infusedDiamond, ModItems.infusedDiamond); // Sugar + String
		...
		addRecipe(bow, UpgradeRegistry.WeaponKnockback.setLevel(1), null, Items.slime_ball, Items.slime_ball, ModItems.infusedDiamond, ModItems.infusedDiamond);// Slime Ball
		...
		ItemStack inkSac = new ItemStack(Items.dye, 1, 0);
		addRecipe(bow, UpgradeRegistry.WeaponBlind.setLevel(1), null, inkSac, inkSac, inkSac, inkSac, ModItems.infusedStar, ModItems.infusedStar); // Soul Sand + Ink Sac
		...
		addRecipe(bow, UpgradeRegistry.WeaponSlow.setLevel(1), null, Blocks.web, Blocks.web, Blocks.soul_sand, Blocks.soul_sand, ModItems.infusedDiamond, ModItems.infusedDiamond); // Cobweb
		...
		addRecipe(bow, UpgradeRegistry.WeaponPhysicalDamage.setLevel(1), null, Items.quartz, Items.quartz, Items.quartz, Items.quartz, ModItems.infusedDiamond, ModItems.infusedDiamond, ModItems.infusedDiamond);// Quartz
		...
		ItemStack witherSkull = new ItemStack(Items.skull, 1, 1);
		addRecipe(bow, UpgradeRegistry.WeaponWitherDamage.setLevel(1), null, witherSkull, witherSkull, witherSkull, ModItems.infusedStar, ModItems.infusedStar, ModItems.infusedStar);// Wither Skeleton Skull
		...
		ItemStack potionHarming = new ItemStack(Items.potionitem, 1, 8204);
		ItemStack potionHarmingII = new ItemStack(Items.potionitem, 1, 8236);
		addRecipe(bow, UpgradeRegistry.WeaponMagicDamage.setLevel(1), null, potionHarming, potionHarming, potionHarming, ModItems.infusedDiamond, ModItems.infusedDiamond, ModItems.infusedDiamond);// Potion of Harming
		...
		addRecipe(bow, UpgradeRegistry.WeaponFireDamage.setLevel(1), null, Items.blaze_rod, Items.blaze_rod, Items.blaze_rod, ModItems.infusedDiamond, ModItems.infusedDiamond, ModItems.infusedDiamond);// Blaze Rod
	...
	private static void armorRecipes()
	{
		...
		addRecipe(armor, UpgradeRegistry.ArmorPhysicalThorns.setLevel(1), null, Blocks.cactus, Blocks.cactus, ModItems.infusedDiamond, ModItems.infusedDiamond); // Cactus
		...
		addRecipe(armor, UpgradeRegistry.ArmorMagicThorns.setLevel(1), null, poisonPotion, poisonPotion, ModItems.infusedDiamond, ModItems.infusedDiamond); // Potion of Poison
		...
		addRecipe(armor, UpgradeRegistry.ArmorBlindThorns.setLevel(1), null, Blocks.soul_sand, Blocks.soul_sand, ModItems.infusedStar, ModItems.infusedStar); // Soul Sand
		...
		addRecipe(armor, UpgradeRegistry.ArmorAbsorption.setLevel(1), null, notchApple, notchApple, Items.glowstone_dust, Items.glowstone_dust, ModItems.infusedDiamond, ModItems.infusedDiamond); // Notch Apple + Glowstone
		...
		addRecipe(armor, UpgradeRegistry.ArmorHealthBoost.setLevel(1), null, notchApple, notchApple, Items.milk_bucket, Items.milk_bucket, ModItems.infusedDiamond, ModItems.infusedDiamond); // Notch Apple + Milk Bucket
		...
		addRecipe(armor, UpgradeRegistry.ArmorResistance.setLevel(1), null, Items.diamond, Items.diamond, Items.diamond, Items.diamond, ModItems.infusedStar, ModItems.infusedStar); // Diamond
		...
		addRecipe(armor, UpgradeRegistry.ArmorPhysicalProtection.setLevel(1), null, Items.iron_ingot, Items.iron_ingot, Items.iron_ingot, Items.iron_ingot, ModItems.infusedDiamond, ModItems.infusedDiamond);// Iron
		...
		addRecipe(armor, UpgradeRegistry.ArmorFireProtection.setLevel(1), null, Items.magma_cream, Items.magma_cream, Items.magma_cream, Items.magma_cream, ModItems.infusedDiamond, ModItems.infusedDiamond);// Magma Cream
		...
		addRecipe(armor, UpgradeRegistry.ArmorBlastProtection.setLevel(1), null, Blocks.obsidian, Blocks.obsidian, Blocks.obsidian, Blocks.obsidian, ModItems.infusedDiamond, ModItems.infusedDiamond);// Obsidian
		...
		addRecipe(armor, UpgradeRegistry.ArmorProjectileProtection.setLevel(1), null, Items.arrow, Items.arrow, Items.arrow, Items.arrow, ModItems.infusedDiamond, ModItems.infusedDiamond);// Arrow
		...
		ItemStack witherSkull = new ItemStack(Items.skull, 1, 1);
		addRecipe(armor, UpgradeRegistry.ArmorWitherProtection.setLevel(1), null, witherSkull, witherSkull, witherSkull, witherSkull, ModItems.infusedStar, ModItems.infusedStar);// Wither Skeleton Skull
		...
		addRecipe(armor, UpgradeRegistry.ArmorMagicProtection.setLevel(1), null, potionHealth, potionHealth, potionHealth, potionHealth, ModItems.infusedStar, ModItems.infusedStar);// Potion of Instant Health
	...
	private static void amuletRecipes()
	{
		...
		addRecipe(amulet, UpgradeRegistry.AmuletFlight.setLevel(1), null, Items.feather, Items.feather, Items.feather, Blocks.dragon_egg, ModItems.platedDiamond, ModItems.platedDiamond);
		
		ItemStack lapis = new ItemStack(Items.dye, 1, 4);
		addRecipe(amulet, UpgradeRegistry.AmuletLooting.setLevel(1), null, lapis, lapis, ModItems.infusedShard);
		...
		if (!Loader.isModLoaded("TravellersGear"))
		{
			addRecipe(amulet, UpgradeRegistry.BaubleFireImmunity.setLevel(1), null, Items.blaze_powder, Items.blaze_powder, Items.gunpowder, Items.gunpowder, ModItems.infusedDiamond, ModItems.infusedDiamond);
			...
			addRecipe(amulet, UpgradeRegistry.BaublePoisonImmunity.setLevel(1), null, Items.fermented_spider_eye, Items.fermented_spider_eye, Items.nether_wart, Items.nether_wart, ModItems.infusedDiamond, ModItems.infusedDiamond);
			...
			ItemStack witherSkull = new ItemStack(Items.skull, 1, 1);
			addRecipe(amulet, UpgradeRegistry.BaubleWitherImmunity.setLevel(1), null, Blocks.soul_sand, Blocks.soul_sand, witherSkull, witherSkull, ModItems.infusedStar, ModItems.infusedStar);
	...
	private static void ringRecipes()
	{
		...
		addRecipe(ring, UpgradeRegistry.RingPotionSwiftness.setLevel(1), null, Items.nether_wart, Items.nether_wart, Items.sugar, Items.sugar, ModItems.infusedDiamond, ModItems.infusedDiamond);
		...
		addRecipe(ring, UpgradeRegistry.RingPotionHaste.setLevel(1), null, Items.nether_wart, Items.nether_wart, Items.redstone, Items.redstone, ModItems.infusedDiamond, ModItems.infusedDiamond);
		...
		addRecipe(ring, UpgradeRegistry.RingPotionStrength.setLevel(1), null, Items.nether_wart, Items.nether_wart, Items.blaze_powder, Items.blaze_powder, ModItems.infusedDiamond, ModItems.infusedDiamond);
		...
		addRecipe(ring, UpgradeRegistry.RingPotionJumpBoost.setLevel(1), null, Items.nether_wart, Items.nether_wart, Items.feather, Items.feather, ModItems.infusedDiamond, ModItems.infusedDiamond);
		...
		addRecipe(ring, UpgradeRegistry.RingPotionRegeneration.setLevel(1), null, Items.nether_wart, Items.nether_wart, Items.ghast_tear, Items.ghast_tear, ModItems.infusedDiamond, ModItems.infusedDiamond);
		...
		addRecipe(ring, UpgradeRegistry.RingPotionNightVision.setLevel(1), null, Items.nether_wart, Items.nether_wart, Items.golden_carrot, Items.golden_carrot, ModItems.platedDiamond, ModItems.platedDiamond);
		
		ItemStack pufferfish = new ItemStack(Items.fish, 1, 3);
		addRecipe(ring, UpgradeRegistry.RingPotionWaterBreathing.setLevel(1), null, Items.nether_wart, Items.nether_wart, pufferfish, pufferfish, ModItems.platedDiamond, ModItems.platedDiamond);
		
		addRecipe(ring, UpgradeRegistry.RingPotionFireResistance.setLevel(1), null, Items.nether_wart, Items.nether_wart, Items.magma_cream, Items.magma_cream, ModItems.platedDiamond, ModItems.platedDiamond);
	}
	...
	private static void beltRecipes()
	{
		...
		addRecipe(belt, UpgradeRegistry.BeltCleave.setLevel(1), null, Items.gunpowder, Items.gunpowder, Items.gunpowder, Items.stone_sword, ModItems.infusedStar, ModItems.infusedStar);
		...
		addRecipe(belt, UpgradeRegistry.BeltKnockback.setLevel(1), null, Blocks.obsidian, Blocks.piston, Blocks.piston, Blocks.piston, ModItems.infusedDiamond, ModItems.infusedDiamond);
		...
		{
			ItemStack notchApple = new ItemStack(Items.golden_apple, 1, 1);
			addRecipe(belt, UpgradeRegistry.BaubleHealthBoost.setLevel(1), null, Items.golden_apple, Items.golden_apple, Items.milk_bucket, Items.milk_bucket, ModItems.infusedStar, ModItems.infusedStar);
			...
			addRecipe(belt, UpgradeRegistry.BaubleMiningLimiter.setLevel(1), null, Blocks.gold_block, Items.string, Items.string, Items.string, Items.string, ModItems.infusedIngot);
		}
	}
	...
	private static void pauldronRecipes()
	{
		...
		addRecipe(pauldron, UpgradeRegistry.BaubleFireImmunity.setLevel(1), null, Items.blaze_powder, Items.blaze_powder, Items.gunpowder, Items.gunpowder, ModItems.infusedDiamond, ModItems.infusedDiamond);
		...
		addRecipe(pauldron, UpgradeRegistry.BaublePoisonImmunity.setLevel(1), null, Items.fermented_spider_eye, Items.fermented_spider_eye, Items.nether_wart, Items.nether_wart, ModItems.infusedDiamond, ModItems.infusedDiamond);
		...
		ItemStack witherSkull = new ItemStack(Items.skull, 1, 1);
		addRecipe(pauldron, UpgradeRegistry.BaubleWitherImmunity.setLevel(1), null, Blocks.soul_sand, Blocks.soul_sand, witherSkull, witherSkull, ModItems.infusedStar, ModItems.infusedStar);
	...
	private static void vambraceRecipes()
	{
		...
		ItemStack notchApple = new ItemStack(Items.golden_apple, 1, 1);
		addRecipe(vambrace, UpgradeRegistry.BaubleHealthBoost.setLevel(1), null, Items.golden_apple, Items.golden_apple, Items.milk_bucket, Items.milk_bucket, ModItems.infusedStar, ModItems.infusedStar);
		...
		addRecipe(vambrace, UpgradeRegistry.BaubleMiningLimiter.setLevel(1), null, Blocks.gold_block, Items.string, Items.string, Items.string, Items.string, ModItems.infusedIngot);
	}
	...
	{
		ArrayList<Upgrade> upgrades = itemUpgrades.remove(item.getItem().getClass());
		if (upgrades == null) upgrades = new ArrayList<Upgrade>();
		upgrades.add(upgrade);
		itemUpgrades.put(item.getItem().getClass(), upgrades);

		ArrayList<ItemStack> items = new ArrayList<ItemStack>();
		for (Object stack : recipeItems)
		{
			if (stack == null) continue;
			else if (stack instanceof ItemStack) items.add((ItemStack) stack);
			else if (stack instanceof Item) items.add(new ItemStack((Item) stack));
			else if (stack instanceof Block) items.add(new ItemStack((Block) stack));
		}
		InfuserRecipes.recipeItems.put(upgrade, items);
		InfuserRecipes.upgradeReqs.put(upgrade, upgradeReq);
	}
	...
	{
		// If either argument is null, the check fails
		if (item == null || pylonItems == null) return null;

		// Make sure no elements of the item array are null either
		...
		// Now that the inputs are validated, get a list of all upgrades available for the given item
		ArrayList<Upgrade> availableUpgrades = itemUpgrades.get(item.getItem().getClass());
		if (availableUpgrades == null || availableUpgrades.size() == 0) return null; // Of course, if there are none, the check fails
		
		// Also get the list of upgrades currently on the item. We'll need this to reduce the amount of available upgrades
		ArrayList<Upgrade> currentUpgrades = getCurrentUpgrades(item);

		// Now, for every upgrade...
		for (Upgrade upgrade : availableUpgrades)
		{
			// Get the specific check for the Helmet of Revealing upgrade out of the way
			if (item.getItem() instanceof ItemModArmor && ((ItemModArmor) item.getItem()).armorType != 0 && upgrade.name.equals(UpgradeRegistry.ArmorRevealing)) continue;
			
			// Make sure that the upgrade isn't replacing higher levels of itself
			boolean highest = true;
			for (Upgrade up : currentUpgrades)
			{
				if (up == null) continue;
				if (upgrade.name.equals(up.name) && upgrade.level <= up.level) highest = false;
			}
			if (!highest) continue;

			// and instead contain the requirement
			if (!currentUpgrades.contains(upgradeReqs.get(upgrade))) continue;

			// And make sure that it is compatible with all the upgrades currently on the item
			boolean compatible = true;
			for (String upgradeName : upgrade.incompatibleUpgrades)
			{
				if (currentUpgrades.contains(new Upgrade(upgradeName)))
				{
					compatible = false;
					break;
				}
			...
			// If the upgrade has gotten to this point, its time to start working with the recipe ingredients
			// If the recipe's items and the pylons' items don't match exactly, the upgrade fails the test
			ArrayList<ItemStack> requiredItems = (ArrayList<ItemStack>) recipeItems.get(upgrade).clone();
	...
	public static ItemStack addUpgrade(ItemStack item, Upgrade upgrade)
	{
		...
		for (int i = 0; i < upgradeList.tagCount(); i++)
		{
			...
			if (oldUpgrade.getString("Name").equals(upgrade.name))
			{
				...
				if (upgrade.level != 0)
				{
					...
					int itemLevel = item.stackTagCompound.getInteger("Level");
					item.stackTagCompound.setInteger("Level", itemLevel + newTag.getInteger("Level") - oldUpgrade.getInteger("Level"));
				}
				else item.stackTagCompound.setInteger("Level", item.stackTagCompound.getInteger("Level") - oldUpgrade.getInteger("Level"));
				item.stackTagCompound.setTag("Upgrades", upgradeList);
				return item;
			}
		}
		...
		if (upgrade.level != 0)
		{
			upgradeList.appendTag(newTag);
			int itemLevel = item.stackTagCompound.getInteger("Level");
			item.stackTagCompound.setInteger("Level", itemLevel + newTag.getInteger("Level"));
		}
		item.stackTagCompound.setTag("Upgrades", upgradeList);
		return item;
	}
