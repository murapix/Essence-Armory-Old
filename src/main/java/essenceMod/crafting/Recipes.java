...
public class Recipes
{
	public static void init()
	{
		...
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.crystalDiamond), new Object[] { " A ", "ABA", " A ", 'A', ModItems.infusedNugget, 'B', Items.diamond, 'C', Items.iron_ingot });
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.crystalStar), new Object[] { " A ", "ABA", " A ", 'A', ModItems.infusedNugget, 'B', Items.nether_star, 'C', Items.iron_ingot });
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.platedDiamond), new Object[] { " A ", "ABA", " A ", 'A', ModItems.infusedIngot, 'B', ModItems.crystalDiamond, 'C', Items.gold_ingot });
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.platedStar), new Object[] { " A ", "ABA", " A ", 'A', ModItems.infusedIngot, 'B', ModItems.crystalStar, 'C', Items.gold_ingot });
